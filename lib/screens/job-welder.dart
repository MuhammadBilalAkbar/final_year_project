...
class Welder extends StatefulWidget {
  String fcm;

  Welder(this.fcm);
  static const routeName = '/Welder';

  @override
  _WelderState createState() => _WelderState(this.fcm);
}

class _WelderState extends State<Welder> {
  String fcm;

  _WelderState(this.fcm);
