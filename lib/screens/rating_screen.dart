...
class RatingCard extends StatefulWidget {
  ...
  // String userId;
  // String _token;
  RatingCard({required this.techid, required this.jobId});
  // const RatingCard({
  //   Key key,
  //   this.userId,
  //   this._token
...
class _RatingCardState extends State<RatingCard> {
  ...
  // final String jobId;
  //
  //  _RatingCardState({required this.techid, required this.jobId});
                         ...
                         Text("RATING"),
                          ...
                          if (_isLoading)
                            ...
                            ElevatedButton(
                              child: Text('Submit'),
                              onPressed: () async {
                                 user.updateRating(widget.techid, widget.ratings!);
                                user.updatevar(widget.jobId);
                                showDialog(
                                    context: context,
