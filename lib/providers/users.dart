...
class Users with ChangeNotifier {
  ...
  Users( this.authToken,  this.id,  this.newUser);
  List<User> get user {
    return [...newUser];
  }
...
//&orderBy="creatorId"&equalTo="$id"
  ...
  Future<void> sortTechs({required double lat, required double long, required String type}) async {
    ...
    _sortedtechs.sort((a,b) => a.distance!.compareTo(double.parse(b.distance.toString())));
  ...
  Future<bool> addUserData(String authToken, String userId, String fullName,
